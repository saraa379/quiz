...
class Starsplanets extends Component {
	...
	componentDidMount() {
		...
		fire.database().ref('Starplanet/' + ind1).once('value', function(snapshot) {
		...
		fire.database().ref('Starplanet/' + ind2).once('value', function(snapshot) {
		...
		fire.database().ref('Starplanet/' + ind3).once('value', function(snapshot) {
		...
		fire.database().ref('Starplanet/' + ind4).once('value', function(snapshot) {
		...
		fire.database().ref('Starplanet/' + ind5).once('value', function(snapshot) {
	...
	render() {
		...
		if (this.state.currentPage == 2) {
			return <QuizPage quizType="Stars and planet" page="2"
								score={this.state.score}
								quiz={this.state.quiz2}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 3) {
			return <QuizPage quizType="Stars and planet" page="3"
								score={this.state.score}
								quiz={this.state.quiz3}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 4) {
			return <QuizPage quizType="Stars and planet" page="4"
								score={this.state.score}
								quiz={this.state.quiz4}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 5) {
			return <QuizPage quizType="Stars and planet" page="5"
								score={this.state.score}
		...
		return (
				<QuizPage quizType="Stars and planet" page="1"
									score={this.state.score}
