...
class Earth extends Component {
	...
	restart(){
		...
		fire.database().ref('Earth/' + ind1).once('value', function(snapshot) {
		...
		fire.database().ref('Earth/' + ind2).once('value', function(snapshot) {
		...
		fire.database().ref('Earth/' + ind3).once('value', function(snapshot) {
		...
		fire.database().ref('Earth/' + ind4).once('value', function(snapshot) {
		...
		fire.database().ref('Earth/' + ind5).once('value', function(snapshot) {
	...
	render() {
		...
		if (this.state.currentPage == 2) {
			return <QuizPage quizType="Earth" page="2"
								score={this.state.score}
								quiz={this.state.quiz2}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 3) {
			return <QuizPage quizType="Earth" page="3"
								score={this.state.score}
								quiz={this.state.quiz3}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 4) {
			return <QuizPage quizType="Earth" page="4"
								score={this.state.score}
								quiz={this.state.quiz4}
								callbackQuiz={this.quizClicked}
								/>
		} else if(this.state.currentPage == 5) {
			return <QuizPage quizType="Earth" page="5"
								score={this.state.score}
		...
		return (
				<QuizPage quizType="Earth" page="1"
									score={this.state.score}
